                ...
                <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                    ...
                    <div className="lg:w-1/2 order-2 w-full max-w-md lg:max-w-none mx-auto">
                        <div className="relative">
                            ...
                            <img 
                                src="https://i.postimg.cc/1Rbv3q2K/Gemini-Generated-Image-51z94751z94751z9.png" 
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="text-center md:text-left">
                    <h2 className="text-2xl md:text-3xl font-serif font-bold text-white mb-4">Une approche globale et bienveillante</h2>
